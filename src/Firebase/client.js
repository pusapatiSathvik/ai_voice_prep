...
const firebaseConfig = {
    ...
    authDomain: "voice-prep.firebaseapp.com",
    projectId: "voice-prep",
    storageBucket: "voice-prep.appspot.com",  // Corrected bucket name
    messagingSenderId: "677308890702",
    appId: "1:677308890702:web:d321846e9134bb4ef88d1f",
    measurementId: "G-CPMV8GGG0C"
};
...
// Initialize Firebase
const app = !getApps().length ? initializeApp(firebaseConfig) : getApp();  // Corrected getApps()

export const auth = getAuth(app);
export const db = getFirestore(app);
//  No need to export app
